  ...
  return (
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="mb-12 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700">
          <div className="p-8">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
              How one curved blind-side run and a midfield turnover created the first goal of the
              FIFA World Cup 2026.
            </p>
