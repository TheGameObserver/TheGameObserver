...
export default async function TacticalTopicPage({ params }: TacticalTopicPageProps) {
  ...
  if (posts.length === 0) {
    return (
      <div className="mx-auto max-w-5xl px-4 py-12">
        ...
        <h1 className="mt-2 text-4xl font-bold text-gray-900 dark:text-white">Topic Not Found</h1>

        <p className="mt-4 text-gray-600 dark:text-gray-400">
          We could not find any articles for this tactical topic.
        </p>
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12">
      <div className="mb-10">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400">
          Tactical analysis and football articles related to {topicName}.
        </p>
      </div>
      ...
      <div className="mt-10 border-t border-gray-200 pt-6 dark:border-gray-700">
        <Link href="/tactical-topics" className="text-primary-500 hover:text-primary-600">
          ← Back to tactical topics
        </Link>
      </div>
    </div>
